...
fun MainScreen() {
    ...
    //contains the selected camera ID for opening later. Front camera, back camera, etc.
...
fun validateForCamera(context: Context): String {
    ...
    for (cameraId in cameraIds) {
        ...
        //get resolution required by the camera for RAW capture
